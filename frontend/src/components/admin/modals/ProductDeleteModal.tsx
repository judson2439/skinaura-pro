/**
 * @fileoverview Product Delete Confirmation Modal Component
 */
...
const ProductDeleteModal: React.FC<ProductDeleteModalProps> = ({ product, isOpen, onClose, onConfirm, isDeleting }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md m-4 p-6">
        ...
        {product.brand && (
          <p className="text-xs text-gray-400 text-center mb-6">Brand: {product.brand}</p>
        )}
